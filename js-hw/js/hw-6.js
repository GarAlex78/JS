...
// const im = getUsersWithGender(users, "male");
// console.log("im: ", im); // [ 'Moore Hensley', 'Ross Vazquez', 'Carey Barr', 'Blackburn Dotson' ]
// //---------------------------------------------------
...
//   users.map(user => user.balance).reduce((acc, user) => acc + user, 0);
